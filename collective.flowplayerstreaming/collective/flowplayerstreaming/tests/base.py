...
def setup_product():
    ...
    import collective.flowplayerstreaming
    zcml.load_config('configure.zcml', collective.flowplayerstreaming)
    ...
    ztc.installPackage('collective.flowplayerstreaming')
...
setup_product()
ptc.setupPloneSite(products=['collective.flowplayerstreaming'])
